		...
		do
			case $choice in 
				"Column")
					...
					rows_num=$(awk -F ":" 'END{print NR}' $1/$st_name)
					if [[ $scol_num =~ ^[0-9]+$ ]]
					then
				...
				"Row")
					...
					rows_num=$(awk 'END{print NR}' $1/$st_name)
					if [[ $srow_num =~ ^[0-9]+$ ]]
					then
                          ...
                          2) read -p "Enter the name of the column you want to delete: " colu
                                ...
                                then
                                        ...
                                        then
                                                ...
                                                awk -i inplace -v i=$colu_num -v OFS=":" -F":" '{
                                                        if(NR > 3) {$i=""}; print $0}' "$db_path"/"$d_name"
...
then
        ...
        then
                ...
                num_col=$(aw2k -F":" '{if (NR==1) print NF}' $db_path/$i_name)
                        for (( i=1; i<=num_col; i++ ))
                        do
                                ...
                                then
                                        ...
                                        then
                                                ...
                                                then
                                                        ...
                                                        then
                                                                echo "Primary key value can not be NULL!"
                                                        else
